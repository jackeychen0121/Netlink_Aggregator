...
const PageNav: Component = () => {
  return (
    <Motion.div
      class="z-50 m-4 inline-flex max-w-xs flex-row justify-center gap-4 rounded-full px-6 py-4 shadow backdrop-blur-lg bg-slate-900"
      initial={{
  ...
  return (
    <div class='w-full bg-white h-screen'>
      <Router>
        ...
        <Motion.div
          class="z-0 grid w-full h-[calc(100vh-88px)]"
          initial={{
